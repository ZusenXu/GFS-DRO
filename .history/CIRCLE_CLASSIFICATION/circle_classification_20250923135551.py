...
def plot_frame_samples(model, X, y, X_perturbed, title, save_path, method, epoch):
    ...
    if X_perturbed is not None:
        ...
        ax.scatter(X_p_np[y_repeated==1, 0], X_p_np[y_repeated==1, 1], c='darkorange', marker='o',edgecolors="gray", linewidths=0.2, s=15)
        ax.scatter(X_p_np[y_repeated==0, 0], X_p_np[y_repeated==0, 1], c='dodgerblue', marker='o',edgecolors="gray", linewidths=0.2, s=15)
