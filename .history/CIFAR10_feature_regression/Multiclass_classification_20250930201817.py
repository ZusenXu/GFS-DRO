    ...
    if not os.path.exists(file_path):
        ...
        for lam in lam_values:
            for eps in eps_values:
                all_runs_training_losses = {"WGF": [], "Dual": [], "WFR": [], "SVG": []}
                all_runs_eval_results = {"WGF": [], "SAA": [], "Dual": [], "WRM": [], "WFR": [], "SVG": []}
                # all_runs_training_losses = {"WGF": [], "Dual": [], "WFR": []} #"RGO": [], 
                # all_runs_eval_results = {"WGF": [], "SAA": [], "Dual": [], "WRM": [], "WFR": []} #"RGO": [], 
                for i in range(N_REPEATS):
                    ...
                    models_to_evaluate = {
                        ...
                        "WRM": WRM_model, 
                        "WFR": WFR_dro_model,
                        "SVG": SVG_dro_model # Add the new SVG model here
                    } #, "RGO": rgo_dro_model
                    #models_to_evaluate = {"SAA": saa_model_wrapper, "Dual": base_dro_model, "WGF": WGF_dro_model, "WRM": WRM_model, "WFR": WFR_dro_model} #, "RGO": rgo_dro_model
