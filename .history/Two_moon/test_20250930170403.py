...
def svg_sampler(
    ...
    particles += torch.randn_like(particles) * 0.2 #* np.sqrt(EPSILON / 2)
...
def plot_perturbation_process(saa_model, X_train, y_train, method, output_dir, lr=0.001, inner_steps=500, adagrad_hist_decay=0.9):
...
if __name__ == '__main__':
    ...
    # --- DRO Models Training ---
    dro_methods_to_train = ["SVG", "WRM", "Dual", "RGO"] #"MMD", "WFR", "WGF", 
