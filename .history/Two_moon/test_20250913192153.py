...
def plot_perturbation_process(saa_model, X_train, y_train, method, output_dir, lr=0.01, inner_steps=20, num_samples_per_point=5):
    """
...
def plot_objective_comparison(histories: Dict[str, list], save_path: str):
    ...
    plt.ylabel("loss")
    plt.title("Averaged Objective Values Variation")
    plt.legend()
    plt.grid(False)
    plt.savefig(save_path)
    plt.close()
