...
def mul_ld_sampler(x_original_batch, y_original_batch, model, lr=1e-3, inner_steps=50):
    x_clone = x_original_batch.clone().detach().requires_grad_(True)
...
def wfr_sampler(x_original_batch, y_original_batch, model, lr=1e-3, inner_steps=50):
