...
if __name__ == '__main__':
    ...
    model_names = ["SAA", "Dual", "WGF", "WRM", "WFR"]#"LD", "SVGD","RGO", 
    loss_histories = {name: [] for name in ["Dual", "WGF", "WFR"]}  # SAA does not use DRO loss "LD", "WRM", "SVGD", "RGO", 
    ...
    # --- DRO Models Training ---
    dro_methods_to_train = ["WFR", "WRM", "WGF", "Dual"] #"LD",  , "SVGD" "RGO", 
