...
def plot_perturbation_process(saa_model, X_train, y_train, method, output_dir, lr=0.001, inner_steps=500, adagrad_hist_decay=0.9, svg_noise_std=0.1):
    ...
    # Special handling for RGO's two-phase process
    if method == 'RGO':
        ...
        for step in tqdm(range(opt_steps), desc=f"Generating RGO Optimization frames"):
            ...
            if step % 10 == 0:
                ...
                plot_frame_samples(saa_model, X_train, y_train, plot_X_p, f"Perturbation Process ({method})",
    ...
    else: # Logic for all other methods
        weights = None
...
if __name__ == '__main__':
    ...
    all_methods = [ "WRM", "SVG", "WGF", "WFR"] #"RGO", 
    comparison_histories = {}
    for method in all_methods:
        if method == "SVG":
            # Run for SVG with noise 0.1
    ...
    # --- DRO Models Training ---
    dro_methods_to_train = ["SVG", "WRM", "Dual", "WFR", "WGF"] #"RGO", 
