...
if __name__ == '__main__':
    ...
    model_names = ["SAA", "RGO", "LD", "Dual", "MultiLD", "Sinha"]
    loss_histories = {name: [] for name in ["RGO", "LD", "Dual", "MultiLD", "Sinha"]}  # SAA does not use DRO loss
    ...
    # --- DRO Models Training ---
    dro_methods_to_train = ["Sinha", "MultiLD", "RGO", "LD", "Dual"]
    ...
    for method in dro_methods_to_train:
        ...
        for epoch in tqdm(range(MAX_EPOCHS), desc=f"{method} Training"):
            ...
            if method in ["RGO", "LD", "MultiLD", "Sinha"]:
                model.eval()
                if method == "MultiLD":
        ...
        if imageio and method in ["RGO", "LD", "MultiLD", "Sinha"]:
