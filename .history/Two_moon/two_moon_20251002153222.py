...
def svg_sampler(
    ...
    particles += torch.randn_like(particles) * 0.1 #* np.sqrt(EPSILON / 2)
...
if __name__ == '__main__':
    ...
    for method in all_methods:
        history = plot_perturbation_process(saa_model, X_train, y_train, method, OUTPUT_DIR, lr=0.005, inner_steps=300)
