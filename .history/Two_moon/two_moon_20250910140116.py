...
def plot_frame_samples(model, true_boundary_model, X, y, X_perturbed, title, save_path, method, epoch, weights=None):
    ...
    legend_elements = [
        ...
        Line2D([0], [0], linestyle='None', marker='o', color='darkorange', label='Perturbed Positive', markersize=5, markeredgecolor="gray", markeredgewidth=0.2, s=15),
        Line2D([0], [0], linestyle='None', marker='o', color='dodgerblue', label='Perturbed Negative', markersize=5, markeredgecolor="gray", markeredgewidth=0.2, s=15)
    ]
