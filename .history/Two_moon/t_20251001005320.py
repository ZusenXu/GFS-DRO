...
" in the Canvas "Adapted Two Moons Experiment". I'm asking you to make some changes to this code. Thank you.
I have made some changes to the 'proximal_rejection_sampler', it seems that the calculation of gradient and loss is not very optimal. So I changed it to calculate in a more batch-wise manner. Also, I think there is something wrong with the 'accelerated_gradient_method', I changed it to a more standard version of Nesterov's accelerated gradient method. I also fixed a bug in 'plot_frame_samples' where the shape of 'y_repeated' is not correct when 'num_repeats' is 1. Can you help me to check whether my change is correct? And run the visualization part for proximal rejection sampler. The part to be run is commented out.
