...
inner_lr = 1e-2
inner_steps = 100
wfr_times = 32  # Times the inner_lr for WFR sampler
...
def plot_perturbation_process(saa_model, X_train, y_train, method, output_dir, lr=0.0005, inner_steps=600, num_samples_per_point=4):
    """
