...
def plot_perturbation_process(saa_model, X_train, y_train, method, output_dir, lr=0.0001, inner_steps=1000, num_samples_per_point=4):
    """
    ...
    if imageio:
        ...
        with imageio.get_writer(gif_path, mode='I', fps=60, loop=0, format='gif') as writer:
