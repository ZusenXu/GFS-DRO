...
if __name__ == '__main__':
    ...
    sl_dro_model = SinkhornLinearDRO(INPUT_DIM, NUM_CLASSES, device=DEVICE, lambda_param=lam, epsilon=eps, max_iter=1, learning_rate=8e-2, batch_size=DRO_BATCH_SIZE)
